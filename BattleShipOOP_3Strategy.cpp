/*
    ...
    ----------------------------------------------------
    - Mo phong 3 chien thuat ban tau va 1 chien thuat dat tau ngau nhien.
    - Chay 9 matchup, moi matchup mac dinh 100000 tran.
    - Co the truyen so tran qua command line de test nhanh:
        g++ BattleShipOOP_3Strategy.cpp -O2 -std=c++11 -o battleship_3strategy
        ./battleship_3strategy 1000
*/
